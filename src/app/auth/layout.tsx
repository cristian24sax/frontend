...
export default function AuthLayout({ children }: AuthLayoutProps) {
  return (
    <div className="flex flex-col justify-center items-center h-[100vh] relative">
      ...
      {/* Header */}
      <header className="w-full bg-black text-white flex justify-between items-center p-4 absolute top-0 left-0">
      ...
      {/* Top-left text */}
      <p className="text-white text-sm absolute top-16 left-0 ml-3 xs:hidden md:block md:text-md xl:text-xl pt-1">Transformar la industria peruana en referente mundial</p>

      {/* Top-right text */}
      <p className="text-white text-sm absolute top-16 right-0 mr-3 xs:hidden md:block md:text-md xl:text-xl pt-1">Aprende con profesionales que han implementado exitosamente</p>
